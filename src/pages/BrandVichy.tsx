...
export default function BrandVichy() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter(product => {
      ...
      const tags = (product.node as { tags?: string | string[] }).tags;
      const tagsStr = Array.isArray(tags) ? tags.join(' ').toLowerCase() : (tags?.toLowerCase() || '');
      return range.keywords!.some(keyword => 
        title.includes(keyword.toLowerCase()) || tagsStr.includes(keyword.toLowerCase())
      );
    });
